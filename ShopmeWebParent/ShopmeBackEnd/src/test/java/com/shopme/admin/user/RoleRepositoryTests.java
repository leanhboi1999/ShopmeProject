...
public class RoleRepositoryTests {
	...
	public void testCreateRestRole() {
		Role roleSale = new Role("Saleperson", "manage product price, customers, shipping, orders and sales report");
		...
		repo.saveAll(List.of(roleSale, roleEditor, roleShipper, roleAssistant));
	}
}
